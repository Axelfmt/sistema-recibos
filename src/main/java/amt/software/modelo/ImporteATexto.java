...
public class ImporteATexto {
     ...
     */
    private static ImporteATexto instancia = new ImporteATexto();
    private ImporteATexto() {}
    public static ImporteATexto getInstancia() {
        return instancia;
    }
    ...
    public String cantidadConLetra(String s) {
        ...
        Double parteDecimal = totalBigDecimal.doubleValue();
        int triDesima        = (int)((parteDecimal * 100) % 100);
        ...
        if (triDesima == 0) {
            ...
            result.append("Pesos con ");

            if (triUnidades > 0) result.append(triTexto(triDesima).toString());
